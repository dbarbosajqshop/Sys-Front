...
export default function AllSales() {
  ...
  const { orders, loading, fetchOrders, removeOrder } = useOrders("all");

  const navigate = useNavigate();

  useEffect(() => {
    fetchOrders({ search: dSearch, param: selectedFilter });
  ...
  const handlePageClick = (page: number) =>
    fetchOrders({ page, search: dSearch, param: selectedFilter });
