...
import { getItemsCost } from "@/services/items";
...
export const useReportCost = () => {
  ...
  const fetchItems = useCallback(async ({
    ...
    try {
      ...
      const response = await getItemsCost(page, limit, param, search, formattedStartDate, formattedEndDate);
